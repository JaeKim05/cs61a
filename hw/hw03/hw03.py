...
def pingpong(n):
    ...
    """
    "*** YOUR CODE HERE ***"
    def helper(i, total, direction):
        if i == n:
            return total
        elif i % 7 == 0 or num_sevens(i) > 0:
            return helper(i + 1, total - direction, direction * -1)
        return helper(i + 1, total + direction, direction)
    return helper(1, 1, 1)
...
def count_change(total):
    ...
    """
    "*** YOUR CODE HERE ***"
    def highest_coin(coin):
        if coin > total:
            return coin // 2
        return highest_coin(coin * 2)
    ...
    return count_partitions(total, highest_coin(1))
